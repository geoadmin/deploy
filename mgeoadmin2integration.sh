...
PRODFILE=`pwd`/mgeoadmin2prod.sh
INTWITHSNAPFILE=`pwd`/mgeoadmin2integrationwithsnapshot.sh
PROJECTPATH=/var/www/vhosts/mfm-geoadmin2/private/mgeoadmin/
SNAPSHOTPATH=/var/www/vhosts/mfm-geoadmin2/private/snapshots/`date '+%Y%m%d%H%M'`
