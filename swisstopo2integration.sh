...
PRODFILE=`pwd`/swisstopo2prod.sh
INTWITHSNAPFILE=`pwd`/swisstopo2integrationwithsnapshot.sh
PROJECTPATH=/var/www/vhosts/mf-swisstopo/private/swisstopo/
SNAPSHOTPATH=/var/www/vhosts/mf-swisstopo/private/snapshots/`date '+%Y%m%d%H%M'`
