...
PRODFILE=`pwd`/geoadmin2prod.sh
INTWITHSNAPFILE=`pwd`/geoadmin2integrationwithsnapshot.sh
PROJECTPATH=/var/www/vhosts/mf-geoadmin2/private/geoadmin/
SNAPSHOTPATH=/var/www/vhosts/mf-geoadmin2/private/snapshots/`date '+%Y%m%d%H%M'`
