...
PRODFILE=`pwd`/chsdi3prod.sh
INTWITHSNAPFILE=`pwd`/chsdi3integrationwithsnapshot.sh
PROJECTPATH=/var/www/vhosts/mf-chsdi3/private/chsdi/
SNAPSHOTPATH=/var/www/vhosts/mf-chsdi3/private/snapshots/`date '+%Y%m%d%H%M'`
