...
copy_table() {
    ...
    if [ "$rows" -lt 1000 ]; then jobs=1;increment=$rows; fi
...
do
    ...
    # default value if connection above does not work
    FOO=${diff:=999}
