...
PRODFILE=`pwd`/bafu2prod.sh
INTWITHSNAPFILE=`pwd`/bafu2integrationwithsnapshot.sh
PROJECTPATH=/var/www/vhosts/mf-bafu/private/bafu/
SNAPSHOTPATH=/var/www/vhosts/mf-bafu/private/snapshots/`date '+%Y%m%d%H%M'`
